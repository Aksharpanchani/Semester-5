...
for sigma_squared = sigma_squared_values
 ...
 s1_samples = [A * ones(1, numSamples), -A * ones(1, numSamples)]; % Sampled version of s1(t)
 received_s1 = [A + nk(1:numSamples), -A + nk(numSamples+1:end)]; % Received signal when s1(t) is transmitted
